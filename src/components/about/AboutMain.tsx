  ...
  return (
    <div className="container flex flex-col  gap-5 py-10">
      ...
      <p className="text-sm md:text-lg lg:max-w-[900px]">
        ...
        affordable prices and attention to guests&apos; requests. Every day, a
        large number of different people order from MaxWay. And we try to
        increase both the number of visitors and the number of branches. With
        each cooked dish, we refine the details of original recipes and look for
        the perfect balance of price and continue to be your favorite brand. If
        suddenly you are faced with poor service or low quality of cooked food
        from our side, be sure to write to us at @maxwaymasterfood_bot. We
        gladly accept both positive and negative feedbacks. A guest&apos;s
